...
function runner.env_override(m)
  local live = runner.getenv("FUNISGO_STREAMING_TEST_LIVE")
  local override = runner.getenv("FUNISGO_STREAMING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FUNISGO_STREAMING_TEST_EXPLAIN")
