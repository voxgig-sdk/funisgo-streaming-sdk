...
function runner.env_override(m)
  local live = runner.getenv("FUNISGOSTREAMING_TEST_LIVE")
  local override = runner.getenv("FUNISGOSTREAMING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FUNISGOSTREAMING_TEST_EXPLAIN")
