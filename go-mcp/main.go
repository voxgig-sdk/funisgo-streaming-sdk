// Command FunisgoStreaming-mcp is an MCP server exposing the FunisgoStreaming
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FunisgoStreaming_list  — list records of an entity
//	FunisgoStreaming_load  — load a single record of an entity
//
