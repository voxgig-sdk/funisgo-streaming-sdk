...
type Args struct {
	Entity string         `json:"entity" jsonschema:"channel | movie | series"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FunisgoStreamingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "funisgo-streaming_list",
		Description: "List records from FunisgoStreaming. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "funisgo-streaming_load",
		Description: "Load a single record from FunisgoStreaming. " +
...
func runOp(client *sdk.FunisgoStreamingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FunisgoStreamingSDK, name string) (sdk.FunisgoStreamingEntity, error) {
	switch strings.ToLower(name) {
	case "channel":
		return client.Channel(nil), nil
	case "movie":
		return client.Movie(nil), nil
	case "series":
