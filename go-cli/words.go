...
func registerSDKWords(r *eng.Registry, client *sdk.FunisgoStreamingSDK) {
...
func runOp(client *sdk.FunisgoStreamingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
