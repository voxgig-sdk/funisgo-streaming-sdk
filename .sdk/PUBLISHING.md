...
|---|---|---|
| `ts/` | @voxgig-sdk/funisgo-streaming-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/funisgo-streaming-sdk \
      --repository voxgig-sdk/funisgo-streaming-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/funisgo-streaming-sdk` shows it, and
`npm trust revoke @voxgig-sdk/funisgo-streaming-sdk --id=<id>` removes it.
