...
// FunisgoStreaming SDK audit feature
...
class FunisgoStreamingAuditFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _emit(FunisgoStreamingContext $ctx, string $outcome): void
    {
