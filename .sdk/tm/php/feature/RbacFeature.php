...
// FunisgoStreaming SDK rbac feature
...
class FunisgoStreamingRbacFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _required(FunisgoStreamingContext $ctx): ?string
    {
    ...
    private function _reject(FunisgoStreamingContext $ctx, string $required): void
    {
    ...
    private function _track(FunisgoStreamingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
