...
// FunisgoStreaming SDK clienttrack feature
...
class FunisgoStreamingClienttrackFeature extends FunisgoStreamingBaseFeature
{
    ...
    public function PostConstruct(FunisgoStreamingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FunisgoStreaming-SDK';
