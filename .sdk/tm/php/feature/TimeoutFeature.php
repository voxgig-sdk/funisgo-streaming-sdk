...
// FunisgoStreaming SDK timeout feature
...
class FunisgoStreamingTimeoutFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _with_timeout(FunisgoStreamingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FunisgoStreamingContext $_ctx, float $ms): void
    {
        $client = $this->client;
