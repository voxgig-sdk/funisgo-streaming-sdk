...
// FunisgoStreaming SDK netsim feature
...
class FunisgoStreamingNetsimFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _simulate(FunisgoStreamingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FunisgoStreamingContext $ctx, array $applied): void
    {
        $client = $this->client;
