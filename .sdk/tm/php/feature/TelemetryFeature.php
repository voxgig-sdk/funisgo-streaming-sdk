...
// FunisgoStreaming SDK telemetry feature
...
class FunisgoStreamingTelemetryFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _close(FunisgoStreamingContext $ctx, bool $ok): void
    {
