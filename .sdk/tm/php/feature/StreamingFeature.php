...
// FunisgoStreaming SDK streaming feature
...
class FunisgoStreamingStreamingFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _iterate(FunisgoStreamingResult $result): \Generator
    {
    ...
    private function _streamable(FunisgoStreamingContext $ctx): bool
    {
