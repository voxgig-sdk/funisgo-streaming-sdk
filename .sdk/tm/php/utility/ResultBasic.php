...
// FunisgoStreaming SDK utility: result_basic

class FunisgoStreamingResultBasic
{
    public static function call(FunisgoStreamingContext $ctx): ?FunisgoStreamingResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof FunisgoStreamingError) ? $result->err->msg : (string)$result->err;
