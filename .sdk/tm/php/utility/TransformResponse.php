...
// FunisgoStreaming SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FunisgoStreamingTransformResponse
{
    public static function call(FunisgoStreamingContext $ctx): mixed
    {
        ...
        $transform = FunisgoStreamingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
