...
// FunisgoStreaming SDK utility: graphql
//
...
class FunisgoStreamingGraphql
{
    ...
    // equivalent.
    public static function body(FunisgoStreamingContext $ctx): mixed
    {
    ...
    public static function errors(FunisgoStreamingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
