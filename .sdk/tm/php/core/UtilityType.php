...
// FunisgoStreaming SDK utility type

class FunisgoStreamingUtility
{
    ...
    public static function copy(FunisgoStreamingUtility $src): FunisgoStreamingUtility
    {
        $u = new FunisgoStreamingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
