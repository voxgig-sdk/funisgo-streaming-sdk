...
// FunisgoStreaming SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FunisgoStreamingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FunisgoStreamingOmni::structfix($now, Struct::undef()))
                        !== json_encode(FunisgoStreamingOmni::structfix($val, Struct::undef()))) {
