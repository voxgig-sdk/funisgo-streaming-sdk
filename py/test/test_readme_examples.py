# FunisgoStreaming SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FunisgoStreamingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FunisgoStreamingSDK(...) and FunisgoStreamingSDK.test(...) become
#      FunisgoStreamingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "funisgostreaming_sdk"
_SDK_CLASS = "FunisgoStreamingSDK"
