    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set FUNISGO_STREAMING_TEST_SERIES_ENTID JSON to run live")
        client = setup["client"]
        ...
        series_ref01_data = helpers.to_map(runner.entity_data(series_ref01_ent.create(series_ref01_data, None)))
        ...
        series_ref01_resdata_up0 = helpers.to_map(runner.entity_data(series_ref01_ent.update(series_ref01_data_up0_up, None)))
...
def _series_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("FUNISGO_STREAMING_TEST_SERIES_ENTID"))
