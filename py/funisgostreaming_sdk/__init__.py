...
from funisgostreaming_sdk.utility import register

# Load features
from funisgostreaming_sdk.feature.base_feature import FunisgoStreamingBaseFeature
from funisgostreaming_sdk.features import _has_feature, _make_feature
...
class FunisgoStreamingSDK:
    ...
    def get_utility(self):
        return FunisgoStreamingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FunisgoStreamingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Channel(self, data=None) -> "ChannelEntity":
        ...
        from funisgostreaming_sdk.entity.channel_entity import ChannelEntity
        return ChannelEntity(self, data)


    def Movie(self, data=None) -> "MovieEntity":
        """Entity factory: client.Movie().list() / client.Movie().load({"id": ...})."""
        from funisgostreaming_sdk.entity.movie_entity import MovieEntity
    ...
    def Series(self, data=None) -> "SeriesEntity":
        ...
        from funisgostreaming_sdk.entity.series_entity import SeriesEntity
