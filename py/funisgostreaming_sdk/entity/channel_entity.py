...
from funisgostreaming_sdk.funisgostreaming_types import (
    Channel,
    ChannelLoadMatch,
    ChannelListMatch,
    ChannelCreateData,
...
class ChannelEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Channel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Channel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Channel]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Channel().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
