...
from funisgostreaming_sdk.core.helpers import get_ctx_prop, to_map
...
class FunisgoStreamingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FunisgoStreamingControl()
        ...
        if isinstance(sp, FunisgoStreamingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FunisgoStreamingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FunisgoStreamingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FunisgoStreamingOperation({})
    ...
    def make_error(self, code, msg):
        return FunisgoStreamingError(code, msg, self)
