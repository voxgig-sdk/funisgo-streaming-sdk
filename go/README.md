...
```bash
go mod edit -replace github.com/voxgig-sdk/funisgo-streaming-sdk/go=../path/to/github.com/voxgig-sdk/funisgo-streaming-sdk/go
```
...
```
github.com/voxgig-sdk/funisgo-streaming-sdk/go/
...
The root package (`github.com/voxgig-sdk/funisgo-streaming-sdk/go`) re-exports everything needed
