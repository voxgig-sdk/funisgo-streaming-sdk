# FunisgoStreaming Golang SDK

The Golang SDK for the FunisgoStreaming API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/funisgo-streaming-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/funisgo-streaming-sdk=../path/to/github.com/voxgig-sdk/funisgo-streaming-sdk
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FunisgoStreamingSDK
```
...
| `Channel` | `(data map[string]any) FunisgoStreamingEntity` | Create a Channel entity instance. |
| `Movie` | `(data map[string]any) FunisgoStreamingEntity` | Create a Movie entity instance. |
| `Series` | `(data map[string]any) FunisgoStreamingEntity` | Create a Series entity instance. |

### Entity interface (FunisgoStreamingEntity)

All entities implement the `FunisgoStreamingEntity` interface.
...
```
github.com/voxgig-sdk/funisgo-streaming-sdk/
├── funisgo-streaming.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/funisgo-streaming-sdk`) re-exports everything needed
