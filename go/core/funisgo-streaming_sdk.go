...
type FunisgoStreamingSDK struct {
	Mode     string
...
func (sdk *FunisgoStreamingSDK) OptionsMap() map[string]any {
...
func (sdk *FunisgoStreamingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FunisgoStreamingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FunisgoStreamingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FunisgoStreamingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FunisgoStreamingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FunisgoStreamingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FunisgoStreamingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FunisgoStreamingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FunisgoStreamingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FunisgoStreamingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FunisgoStreamingSDK {
	...
	sdk := NewFunisgoStreamingSDK(sdkopts)
	sdk.Mode = "test"
