...
const testSeed = `map[string]any{"entity": map[string]any{"channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "movie": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "series": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
