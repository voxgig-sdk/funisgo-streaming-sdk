...
(0, node_test_1.describe)('ChannelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != channel_ref01_data.id);
        // LIST
        const channel_ref01_match = {};
        const channel_ref01_list = (await channel_ref01_ent.list(channel_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(channel_ref01_list, { id: channel_ref01_data.id })));
        // UPDATE
        const channel_ref01_data_up0 = {};
        ...
        (0, node_assert_1.default)(channel_ref01_resdata_up0.id === channel_ref01_data_up0.id);
        (0, node_assert_1.default)(channel_ref01_resdata_up0[channel_ref01_markdef_up0.name] === channel_ref01_markdef_up0.value);
        // LOAD
        const channel_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(channel_ref01_data_dt0.id === channel_ref01_data.id);
        // REMOVE
        const channel_ref01_match_rm0 = { id: channel_ref01_data.id };
        await channel_ref01_ent.remove(channel_ref01_match_rm0);
        // LIST
        const channel_ref01_match_rt0 = {};
        const channel_ref01_list_rt0 = (await channel_ref01_ent.list(channel_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(channel_ref01_list_rt0, { id: channel_ref01_data.id })));
    });
});
