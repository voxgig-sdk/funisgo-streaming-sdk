...
(0, node_test_1.describe)('MovieDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-movie', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-movie', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-movie', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-movie', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FUNISGO_STREAMING_TEST_MOVIE_ENTID'];
...
//# sourceMappingURL=MovieDirect.test.js.map