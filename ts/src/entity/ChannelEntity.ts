...
class ChannelEntity extends FunisgoStreamingEntityBase<Channel> {
  ...
  async load(this: any, reqmatch?: ChannelLoadMatch, ctrl?: Control): Promise<ChannelEntity> {
  ...
  async list(this: any, reqmatch?: ChannelListMatch, ctrl?: Control): Promise<ChannelEntity[]> {
  ...
  async create(this: any, reqdata?: ChannelCreateData, ctrl?: Control): Promise<ChannelEntity> {
  ...
  async update(this: any, reqdata?: ChannelUpdateData, ctrl?: Control): Promise<ChannelEntity> {
