...
class SeriesEntity extends FunisgoStreamingEntityBase<Series> {
  ...
  async create(this: any, reqdata?: SeriesCreateData, ctrl?: Control): Promise<SeriesEntity> {
  ...
  async update(this: any, reqdata?: SeriesUpdateData, ctrl?: Control): Promise<SeriesEntity> {
  ...
  async remove(
    this: any, reqmatch?: SeriesRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SeriesEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
