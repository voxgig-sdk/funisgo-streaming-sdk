...
raise a `FunisgoStreamingError` (a `StandardError` subclass), so wrap
...
```
rb/
├── FunisgoStreaming_sdk.rb       -- Main SDK module
...
The main module (`FunisgoStreaming_sdk`) exports the SDK class
