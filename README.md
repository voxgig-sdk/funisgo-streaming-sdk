...
The FunisGo API provides a secure and structured way to access streaming content such as movies, series, and channels.

Learn more about FunisGo Streaming API at [funisgo.com](https://funisgo.com).
...
$channels = $client->Channel()->list();
print_r(array_map(fn($item) => $item->data_get(), $channels));
