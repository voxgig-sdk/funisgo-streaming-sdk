...
// FunisgoStreaming SDK paging feature
...
class FunisgoStreamingPagingFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _is_list(FunisgoStreamingContext $ctx): bool
    {
