...
// FunisgoStreaming SDK cache feature
...
class FunisgoStreamingCacheFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _through(FunisgoStreamingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
