...
// FunisgoStreaming SDK proxy feature
...
class FunisgoStreamingProxyFeature extends FunisgoStreamingBaseFeature
{
    ...
    public function init(FunisgoStreamingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FunisgoStreamingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
