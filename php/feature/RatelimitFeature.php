...
// FunisgoStreaming SDK ratelimit feature
...
class FunisgoStreamingRatelimitFeature extends FunisgoStreamingBaseFeature
{
    ...
    private function _acquire(FunisgoStreamingContext $ctx): void
    {
    ...
    private function _track(FunisgoStreamingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
