...
class ChannelEntity
{
    ...
    {
        if ($args) {
            $this->_data = FunisgoStreamingHelpers::to_map(Struct::clone($args)) ?? [];
    ...
    {
        if ($args) {
            $this->_match = FunisgoStreamingHelpers::to_map(Struct::clone($args)) ?? [];
     ...
     *
     * @param ChannelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChannelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Channel|array The loaded Channel as an assoc-array at the
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = FunisgoStreamingHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
     ...
     *
     * @param ChannelListMatch|array|null $reqmatch Match filter (any subset
     *   of Channel fields) as an assoc-array; ChannelListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Channel[]|array A list of Channel items as assoc-arrays at
     ...
     *
     * @param ChannelCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChannelCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Channel|array The created Channel as an assoc-array at the
     *   SDK boundary; throws FunisgoStreamingError on failure (item-5 convention).
     */
     ...
     *
     * @param ChannelUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChannelUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Channel|array The updated Channel as an assoc-array at the
     *   SDK boundary; throws FunisgoStreamingError on failure (item-5 convention).
     */
