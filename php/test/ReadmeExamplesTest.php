...
// FunisgoStreaming SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FunisgoStreamingSDK::test)
...
{
    private const SDK_CLASS = 'FunisgoStreamingSDK';
    ...
    private const SDK_BASE = 'funisgostreaming_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../funisgostreaming_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
