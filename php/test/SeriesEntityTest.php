...
class SeriesEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FUNISGOSTREAMING_TEST_SERIES_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function series_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FUNISGOSTREAMING_TEST_SERIES_ENTID");
