...
// FunisgoStreaming SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FunisgoStreamingMakeRequest
{
    public static function call(FunisgoStreamingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FunisgoStreamingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FunisgoStreamingResponse($fetched);
        } else {
