...
// FunisgoStreaming SDK utility: make_options

class FunisgoStreamingMakeOptions
{
    ...
    public static function call(FunisgoStreamingContext $ctx): array
    {
        ...
        //
        // `FunisgoStreamingSchema::optspec()` is built from the model:
        ...
        $optspec = FunisgoStreamingSchema::optspec();
