...
// FunisgoStreaming SDK utility: fetcher

class FunisgoStreamingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FunisgoStreamingSDK/1.0)';
    ...
    public static function call(FunisgoStreamingContext $ctx, string $fullurl, array $fetchdef): array
    {
